...
<c:set var="date"><fmt:formatDate value="${today}" pattern="yyyy-MM-dd" /></c:set>
    ...
    <div class="notice-content">
        ...
        <div class="notice-naeyong">
        	<form id="boardForm" action="/insertBoard.do" method="post" enctype="multipart/form-data">
            <table class="notice-tbl">
                ...
                <tr>
                	<td colspan="4" style="text-align: center;height: 55px;">
                    	<input type="submit" id="boardBtn" class="notice-btn"  onclick="submitContents(this)" value="등록">
